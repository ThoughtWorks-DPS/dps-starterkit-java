...
import {{cookiecutter.PKG_TL_NAME}}.{{cookiecutter.PKG_ORG_NAME}}.starter.boot.test.data.provider.GenericDataFactory;
...
@Component
public class {{cookiecutter.RESOURCE_NAME}}DataFactory extends GenericDataFactory<{{cookiecutter.RESOURCE_NAME}}Data> {
